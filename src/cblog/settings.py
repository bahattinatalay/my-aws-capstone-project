...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cegl1g3jtbit.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'bahattinblog' # please enter your s3 bucket name
